...
@section('content')
  ...
  {!! Form::open(['url' => '/', 'method' => 'get', 'id' => 'frmSearch']) !!}
    ...
    <div class="form-check form-check-inline" style="margin-left:32.7em">
      {{ Form::radio('service', '1900', false, ['id'=>'rad1900', 'class'=>'form-check-input'])}}
      {{ Form::label('rad1900', 'Service 1900', ['class'=>'form-check-label'])}}
    </div>   
    <div class="form-check form-check-inline">
      {{ Form::radio('service', 'internal', false, ['id'=>'radInternal', 'class'=>'form-check-input'])}}
      {{ Form::label('radInternal', 'Internal', ['class'=>'form-check-label'])}}
    </div>      
...
@section('scripts')
  ...
  <script>
    ...
    $(document).ready(function(){
      ...
      // $("input[name='service']").on('click', function(e) {
      //   alert($this.val());
      // })
